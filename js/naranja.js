...
;(function (factory) {
  ...
  function setSideUpAnimation(finalNotification) {
    setTimeout(function () {
      var notificaciónHeight = finalNotification.querySelector(
  ...
  if (!$narjContainer) {
    ...
    $newNotificationsAdvice = createElement('div', [
  ...
  return {
    ...
    chooseIcon: {
      ...
      success:
        '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="24" fill="#fff" fill-opacity="0.62"/><path d="M36 16.5L19.5 33L12 25.5" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
